                        ...
                        <div className="col-md-12">
                            <div class="header-main">
                                ...
                                <div className="text-center main-text">
                                    <h3>HELLO, I AM MOHAMMAD MEHEDI HASAN BHUIYAN</h3>
                                    <h4>I'm a</h4>
                                    <h1 class="mb-5">
                                        <Typical
                                            steps={['Front-End Web Developer', 1000, 'Programmer', 1000, 'Gamer', 1000, 'Learner', 1000, 'Computer Science Engineer', 1000]}
                                            loop={Infinity}
                                            wrapper="b"
                                        />
                                    </h1>
